...
class TeamContentDisplayPage extends StatelessWidget {
  ...
  TeamContentDisplayPage(this.content);
                ...
                background: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/imports/emma.jpg'),
                      fit: BoxFit.cover
                    )
                  ),
                  child: Container(
                    ...
                    children: <Widget>[
                      ...
                      FadeAnimation(1.8, Container(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            makeVideo(image: 'assets/imports/emma-1.jpg'),
                            makeVideo(image: 'assets/imports/emma-2.jpg'),
                            makeVideo(image: 'assets/imports/emma-3.jpg'),
                          ],
                        ),
                      )),
                      SizedBox(height: 120,)
