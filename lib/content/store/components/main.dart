          ...
          children: <Widget>[
            FadeAnimation(1, Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Image.asset('assets/imports/menu.png', width: 20,)),
                  SizedBox(height: 15,),
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        flex: 3,
                        child: FadeAnimation(1.3, Image.asset('assets/imports/header-socks.png')),
                      ),
                    ],
                  )
                ],
