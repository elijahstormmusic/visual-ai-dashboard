          ...
          Positioned(
            ...
            child: FadeAnimation(1.2, Container(
              ...
              child: Transform.translate(
                offset: Offset(30, -30),
                child: FadeAnimation(1.3, Image.asset('assets/imports/details-page-header.png',)),
              ),
            )),
          ),
          Positioned(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Image.asset('assets/imports/socks-icon.png'),
                                  ),
                                  SizedBox(width: 10,),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Image.asset('assets/imports/socks-icon-left.png'),
                                  ),
                                  SizedBox(width: 10,),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
